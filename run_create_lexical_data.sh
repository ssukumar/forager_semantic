...
python3.11 run_create_lexical_data.py --vocab_fp "data/lexical_data/vocab_home_appliances.csv" --category "HOME APPLIANCES"
...
python3.11 run_create_lexical_data.py --vocab_fp "data/lexical_data/vocab_musical_instruments.csv" --category "MUSICAL INSTRUMENTS"
...
python3.11 run_create_lexical_data.py --vocab_fp "data/lexical_data/vocab_means_of_transport.csv" --category "MEANS OF TRANSPORT"
...
# python3.11 run_create_lexical_data.py --vocab_fp "data/lexical_data/vocab_things_found_in_kitchens.csv" --category "THINGS FOUND IN THE KITCHEN"
...
# python3.11 run_create_lexical_data.py --vocab_fp "data/lexical_data/vocab_non-food_items_found_in_supermarket.csv" --category "NON-FOOD ITEMS FOUND IN SUPERMARKET"
# python3.11 run_create_lexical_data.py --vocab_fp "data/lexical_data/vocab_technology_gadgets_&_devices.csv" --category "TECHNOLOGY GADGETS AND DEVICES"
# python3.11 run_create_lexical_data.py --vocab_fp "data/lexical_data/vocab_occupations.csv" --category "OCCUPATIONS"
